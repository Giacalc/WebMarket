...
public class TecnicoRichieste extends BaseController {
    ...
    private void action_default(HttpServletRequest request, HttpServletResponse response, String user) throws IOException, ServletException, TemplateManagerException, DataException {
        ...
        request.setAttribute("richieste", ((WMDataLayer) request.getAttribute("datalayer")).getRichiestaDAO().getRichiesteNonEvase());

        res.activate("tecnico_richieste.ftl.html", request, response);
    }
    ...
    try {
        ...
        action_default(request, response, user);
            ...
            handleError(ex, request, response);
                ...
                Logger.getLogger(TecnicoRichieste.class.getName()).log(Level.SEVERE, null, ex);
        }
}
    @Override
    public String getServletInfo() {
        return "Servlet nuove richieste tecnico";
    }
}